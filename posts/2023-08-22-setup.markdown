...
If you're like me, and you [make good use of static type checking](https://mrcjkb.dev/posts/2023-08-17-lua-adts.html)
to improve the robustness of your code base, you will almost certainly benefit from not having
to worry about whether or not parts of your plugin have been initialized by the user.
...
- **`vim.g` is a Vimscript/Lua bridge**:
  As such, it may not be suitable for all use cases. For example, [metatables are erased](https://github.com/neovim/neovim/issues/12544#issuecomment-1116794687)[^4].
...
[^4]: Thanks to [**@echanovski**](https://github.com/echasnovski/) for pointing this out to me.
